...
_CLUSTERINGCONFIG_BBOXCOLOR = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="R",
            full_name="ClusteringConfig.BboxColor.R",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="G",
            full_name="ClusteringConfig.BboxColor.G",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="B",
            full_name="ClusteringConfig.BboxColor.B",
            index=2,
            number=3,
            type=5,
            cpp_type=1,
...
_CLUSTERINGCONFIG.fields_by_name[
    "bbox_color"
].message_type = _CLUSTERINGCONFIG_BBOXCOLOR
_POSTPROCESSINGCONFIG_CLASSWISECLUSTERINGCONFIGENTRY.fields_by_name[
    "value"
].message_type = _CLUSTERINGCONFIG
_POSTPROCESSINGCONFIG_CLASSWISECLUSTERINGCONFIGENTRY.containing_type = (
    _POSTPROCESSINGCONFIG
)
_POSTPROCESSINGCONFIG.fields_by_name[
    "classwise_clustering_config"
].message_type = _POSTPROCESSINGCONFIG_CLASSWISECLUSTERINGCONFIGENTRY
...
DBSCANConfig = _reflection.GeneratedProtocolMessageType(
    "DBSCANConfig",
    (_message.Message,),
    dict(
...
ClusteringConfig = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    dict(
        BboxColor=_reflection.GeneratedProtocolMessageType(
            "BboxColor",
            (_message.Message,),
            dict(
...
PostprocessingConfig = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    dict(
        ClasswiseClusteringConfigEntry=_reflection.GeneratedProtocolMessageType(
            "ClasswiseClusteringConfigEntry",
            (_message.Message,),
            dict(
...
_POSTPROCESSINGCONFIG_CLASSWISECLUSTERINGCONFIGENTRY._options = (
